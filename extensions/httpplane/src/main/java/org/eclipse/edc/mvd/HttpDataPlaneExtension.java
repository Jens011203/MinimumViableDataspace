 ...
 */
public class HttpDataPlaneExtension implements ServiceExtension {
    public static final String NAME = "Custom Data Plane HTTP";
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        System.out.println("Custom Http-Data-Plane is in use");
