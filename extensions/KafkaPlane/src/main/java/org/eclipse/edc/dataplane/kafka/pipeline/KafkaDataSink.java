            ...
            producer.send(new ProducerRecord<>(topic, null, is.readAllBytes()), (metadata, exception) -> {
                if (exception != null) {
                    ...
                    if (count % 574712 == 0) {
                        ...
                        Instant allMessagesReceivedTime = Instant.now();
                        System.out.println("_______________ Transfer started at: " + PipelineServiceImpl.transferStartTime);
                        System.out.println("_______________ Transfer finished at: " + allMessagesReceivedTime);
                    }
                }
            });
