...
class KafkaDataSource implements DataSource, Closeable {
    ...
    protected static Instant firstMessageSendTime;

    protected static boolean firstMessageOfFile = true;
    ...
    public StreamResult<Stream<Part>> openPartStream() {
        if (firstMessageOfFile) {
            firstMessageOfFile = false;
            firstMessageSendTime = Instant.now();
        }
