...
dependencies {
    ...
    implementation(project(":extensions:data-plane-http"))

    runtimeOnly(libs.bundles.connector)
    runtimeOnly(libs.edc.core.controlplane)


    runtimeOnly("org.eclipse.edc:control-plane-api:0.2.1")
    runtimeOnly("org.eclipse.edc:control-plane-api-client:0.2.1")
