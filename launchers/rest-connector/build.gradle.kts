...
dependencies {
    ...
    runtimeOnly("org.eclipse.edc:control-plane-api:0.3.1")
    runtimeOnly("org.eclipse.edc:control-plane-api-client:0.3.1")

    runtimeOnly(libs.edc.ext.api.management)
    runtimeOnly(libs.edc.ext.api.management.core)
    ...
    runtimeOnly(project(":extensions:httpplane"))
    runtimeOnly(project(":extensions:KafkaPlane"))
