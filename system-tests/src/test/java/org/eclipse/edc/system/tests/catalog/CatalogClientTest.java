...
class CatalogClientTest {
    ...
    private static final String SECOND_NON_RESTRICTED_ASSET_PREFIX = "aggregatedData";
                ...
                .untilAsserted(() -> {
                    ...
                    assertThat(datasets)
                            ...
                            .allSatisfy(dataset -> assertThat(dataset.getProperty(Asset.PROPERTY_ID))
                                    .isNotNull()
                                    .asString()
                                    .matches(id -> id.startsWith(NON_RESTRICTED_ASSET_PREFIX) || id.startsWith(SECOND_NON_RESTRICTED_ASSET_PREFIX)));
                            ...
                            .allSatisfy(
                                    dataset -> assertThat(dataset.getProperty(Asset.PROPERTY_ID)).asString()
                                            .satisfiesAnyOf(
                                                    ...
                                                    s -> assertThat(s).startsWith(SECOND_NON_RESTRICTED_ASSET_PREFIX),
